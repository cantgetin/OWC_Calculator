                    ...
                    for (int p3 = 0; p3 < players.Count; p3++)
                    {
                        ...
                        for (int p4 = 0; p4 < players.Count; p4++)
                        {
                            ...
                            for (int p5 = 0; p5 < players.Count; p5++)
                            {
                                ...
                                count++;
                                Console.WriteLine(count + ". " + players[p1].Name + " " +
                                                  players[p2].Name + " " + players[p3].Name + " " +
                                                  players[p4].Name + " " + players[p5].Name);
                                sw.WriteLine(count + ". " + players[p1].Name + " " + players[p2].Name +
                                             " " + players[p3].Name + " " + players[p4].Name + " " +
                                             players[p5].Name);
                                ...
                                int maxNM = NM.Max();
                                int maxNM2 = (from number in NM orderby number descending select number)
                                    .Distinct().Skip(1).First();
                                ...
                                int maxHD = HD.Max();
                                int maxHD2 = (from number in HD orderby number descending select number)
                                    .Distinct().Skip(1).First();
                                ...
                                int maxHR = HR.Max();
                                int maxHR2 = (from number in HR orderby number descending select number)
                                    .Distinct().Skip(1).First();
                                ...
                                int maxDT = DT.Max();
                                int maxDT2 = (from number in DT orderby number descending select number)
                                    .Distinct().Skip(1).First();
                                ...
                                int maxFM = FM.Max();
                                int maxFM2 = (from number in FM orderby number descending select number)
                                    .Distinct().Skip(1).First();


                                int wholesum = maxNM + maxNM2 + maxHD + maxHD2 + maxHR + maxHR2 +
                                               maxDT + maxDT2 + maxFM + maxFM2;
